...
function activate(context, reporter, channel, remoteManager) {
    const documentSelector = [{
            language: 'csharp',
            scheme: 'vsls' // Files opened in a Visual Studio Live Share workspace.
        }
    ];
    const options = options_1.Options.Read();
    const server = new server_1.OmniSharpServer(reporter, remoteManager);
