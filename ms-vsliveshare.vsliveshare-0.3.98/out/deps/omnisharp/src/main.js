...
let _channel = null;
function activateLanguageServices(context, reporter, remoteManager) {
    _channel = vscode.window.createOutputChannel('C#');
    OmniSharp.activate(context, reporter, _channel, remoteManager);
}
exports.activateLanguageServices = activateLanguageServices;
function activate(context) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        let omniSharpPromise = OmniSharp.activate(context, reporter, _channel, null);
