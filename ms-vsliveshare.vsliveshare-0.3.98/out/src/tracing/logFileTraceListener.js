    ...
    constructor(processName, logDirectory) {
        ...
        this.openLogFileAsync = (index = 0) => __awaiter(this, void 0, void 0, function* () {
            ...
            if (index === 5) {
                ...
                telemetry_1.Instance.sendFault(telemetry_1.TelemetryEventNames.NAME_LOGS_FILE_FAILED, telemetry_1.FaultType.Error, 'Name Log File Failed - Reached maximum number of attempts.');
                return;
            }
            ...
            try {
                ...
                if (err.code === 'EEXIST') {
                    ...
                    this.canWriteLogs = false;
                    telemetry_1.Instance.sendFault(telemetry_1.TelemetryEventNames.OPEN_LOGS_FAILED, telemetry_1.FaultType.Error, `Name Log File Failed. ${err.message}`, err.stack);
                }
            }
            ...
            return new Promise((resolve, reject) => {
                fs.write(this.fileDescriptior, line + os.EOL, (err) => {
                    if (err) {
                        ...
                        telemetry_1.Instance.sendFault(telemetry_1.TelemetryEventNames.WRITE_LOGS_FAILED, telemetry_1.FaultType.Error, err.message, err.stack);
                    }
                    resolve();
                });
            });
