...
class MessageFactory {
    ...
    static CoauthoringMessage(msg) {
        ...
        switch (msg.messageType) {
            case coauthoringServiceTypes_1.MessageType.FileOpenAcknowledge:
                ...
                break;
            case coauthoringServiceTypes_1.MessageType.FileOpenRequest:
                ...
                break;
            case coauthoringServiceTypes_1.MessageType.FileRelease:
                ...
                break;
            case coauthoringServiceTypes_1.MessageType.JoinAcknowledge:
                ...
                break;
            case coauthoringServiceTypes_1.MessageType.JoinRequest:
                const joinRequestMsg = msg;
                deserializedMsg = MessageFactory.JoinRequestMessage(joinRequestMsg.clientId);
                break;
            case coauthoringServiceTypes_1.MessageType.SaveFile:
            ...
            case coauthoringServiceTypes_1.MessageType.TextChange:
                ...
                break;
            case coauthoringServiceTypes_1.MessageType.Summon:
                const sMsg = msg;
                deserializedMsg = MessageFactory.SummonMessage(sMsg.clientId);
                break;
            case coauthoringServiceTypes_1.MessageType.LayoutScroll:
                const lsMsg = msg;
    ...
    static SummonMessage(clientId) {
        const message = {
            messageType: coauthoringServiceTypes_1.MessageType.Summon,
            clientId: clientId
        };
        return message;
    }
    static FileOpenAcknowledgeMessage(clientId, fileName, joinerId, savedVersionNumber, startServerVersionNumber, changes, fallbackText, history, isReadOnly) {
        ...
        const message = {
            messageType: coauthoringServiceTypes_1.MessageType.FileOpenAcknowledge,
            clientId: clientId || 0,
            fileName: fileName || '',
            joinerId: joinerId || 0,
    ...
    static FileOpenRequestMessage(clientId, fileName, hashCode, sendJumpTo) {
        // If you get an error after re-generating interfaces, make sure you set MessageBase.sendId to optional in coauthoringServiceTypes.ts.
        const message = {
            messageType: coauthoringServiceTypes_1.MessageType.FileOpenRequest,
            clientId: clientId || 0,
            fileName: fileName || '',
            hashCode: hashCode || 0,
    ...
    static FileReleaseMessage(clientId, fileName) {
        // If you get an error after re-generating interfaces, make sure you set MessageBase.sendId to optional in coauthoringServiceTypes.ts.
        let message = {
            messageType: coauthoringServiceTypes_1.MessageType.FileRelease,
            clientId: clientId || 0,
            fileName: fileName || ''
        };
        return message;
    ...
    static JoinAcknowledgeMessage(clientId, joinerId, clientIds, files) {
        // If you get an error after re-generating interfaces, make sure you set MessageBase.sendId to optional in coauthoringServiceTypes.ts.
        let message = {
            messageType: coauthoringServiceTypes_1.MessageType.JoinAcknowledge,
            clientId: clientId || 0,
            joinerId: joinerId || 0,
            clientIds: clientIds || [],
            files: files || []
    ...
    static JoinRequestMessage(clientId) {
        // If you get an error after re-generating interfaces, make sure you set MessageBase.sendId to optional in coauthoringServiceTypes.ts.
        let message = {
            messageType: coauthoringServiceTypes_1.MessageType.JoinRequest,
            clientId: clientId
        };
        return message;
    }
    static SaveFileMessage(clientId, fileName) {
        // If you get an error after re-generating interfaces, make sure you set MessageBase.sendId to optional in coauthoringServiceTypes.ts.
        let message = {
            messageType: coauthoringServiceTypes_1.MessageType.SaveFile,
            clientId: clientId || 0,
            fileName: fileName || ''
        };
        return message;
    ...
    static SelectionChangeMessage(clientId, fileName, serverVersion, start, length, isReversed, forceJumpForId) {
        // If you get an error after re-generating interfaces, make sure you set MessageBase.sendId to optional in coauthoringServiceTypes.ts.
        let message = {
            messageType: coauthoringServiceTypes_1.MessageType.SelectionChange,
            clientId: clientId || 0,
            fileName: fileName || '',
    ...
    static LayoutScrollMessage(clientId, fileName, serverVersion, start, length) {
        const message = {
            messageType: coauthoringServiceTypes_1.MessageType.LayoutScroll,
            clientId: clientId || 0,
            fileName: fileName || '',
            serverVersionNumber: serverVersion || 0,
            start: start || 0,
    ...
    static TextChangeMessage(clientId, fileName, changeServerVersion, changes) {
        // If you get an error after re-generating interfaces, make sure you set MessageBase.sendId to optional in coauthoringServiceTypes.ts.
        const message = {
            messageType: coauthoringServiceTypes_1.MessageType.TextChange,
            changes: changes || [],
