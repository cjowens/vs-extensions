...
LanguageServiceTelemetryEventNames.LSPSERVER_INIT_FAULT = telemetry_1.TelemetryEventNames.FAULT_PREFIX + 'init-lspserver-fault';
LanguageServiceTelemetryEventNames.SUMMARIZE_LSREQUESTS = 'summarize-lsrequests';
LanguageServiceTelemetryEventNames.GET_DIAGNOSTICS_FAULT = telemetry_1.TelemetryEventNames.FAULT_PREFIX + 'get-diagnostics-fault';
...
LanuageServiceTelemetryPropertyNames.SERVICED_REQUESTS = telemetry_1.TelemetryPropertyNames.FEATURE_NAME + 'ServicedRequests';
LanuageServiceTelemetryPropertyNames.REJECTED_REQUESTS = telemetry_1.TelemetryPropertyNames.FEATURE_NAME + 'RejectedRequests';
LanuageServiceTelemetryPropertyNames.UNACKNOWLEDGED_HOST_CHANGES_REJECTS = telemetry_1.TelemetryPropertyNames.FEATURE_NAME + 'UnacknowledgedHostChangesRejects';
