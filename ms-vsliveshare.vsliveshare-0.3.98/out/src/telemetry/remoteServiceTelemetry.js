...
RemoteServiceTelemetry.PROPERTY_PREFIX = telemetry_1.TelemetryPropertyNames.FEATURE_NAME + 'RemoteService.';
exports.RemoteServiceTelemetry = RemoteServiceTelemetry;
class EventNames {
}
EventNames.SERVICE_REQUEST = 'service-request';
EventNames.HANDLE_REQUEST_ERROR = telemetry_1.TelemetryEventNames.FAULT_PREFIX + 'handle-request-error';
EventNames.SEND_REQUEST_ERROR = telemetry_1.TelemetryEventNames.FAULT_PREFIX + 'send-request-error';
class PropertyNames {
}
PropertyNames.SERVICE_NAME = telemetry_1.TelemetryPropertyNames.FEATURE_NAME + 'ServiceName';
PropertyNames.METHOD_NAME = telemetry_1.TelemetryPropertyNames.FEATURE_NAME + 'MethodName';
